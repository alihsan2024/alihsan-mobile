...
- [x] Update API URL to use production endpoint: `https://api.alihsan.org.au`
- [x] Add environment-based URL switching (development/production)
- [ ] Test API connectivity - add connection with localhost.
...
- [x] Create new tab screen for campaigns
