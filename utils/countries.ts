export const countriesList = [
  ...
  { code: "EG", name: "Palestinian Refugees, Egypt", dialCode: "+20" },
  ...
  { code: "HM", name: "Heard Island & Mcdonald Islands", dialCode: "+672" },
  { code: "VA", name: "Holy See (Vatican City State)", dialCode: "+39" },
  ...
  { code: "KR", name: "Korea", dialCode: "+82" },
  ...
  { code: "MM", name: "Rohingya Refugees", dialCode: "+95" },
  ...
  { code: "PS", name: "Gaza, Palestine", dialCode: "+970" },
  ...
  { code: "VC", name: "Saint Vincent And Grenadines", dialCode: "+1" },
  ...
  { code: "GS", name: "South Georgia And Sandwich Isl.", dialCode: "+500" },
  { code: "ES", name: "Spain", dialCode: "+34" },
  { code: "LK", name: "Sri Lanka", dialCode: "+94" },
  { code: "SD", name: "Sudanese Refugees", dialCode: "+249" },
  ...
  { code: "UM", name: "United States Outlying Islands", dialCode: "+1" },
  { code: "UY", name: "Uruguay", dialCode: "+598" },
  { code: "UZ", name: "Uzbekistan", dialCode: "+998" },
  { code: "VU", name: "Vanuatu", dialCode: "+678" },
  { code: "VE", name: "Venezuela", dialCode: "+58" },
  { code: "VN", name: "Vietnam", dialCode: "+84" },
  { code: "VG", name: "Virgin Islands, British", dialCode: "+1" },
  { code: "VI", name: "Virgin Islands, U.S.", dialCode: "+1" },
...
export const getCountryByCode = (code: string) => {
  return countriesList.find((country) => country.code === code);
};

export const getCountryByDialCode = (dialCode: string) => {
  return countriesList.find((country) => country.dialCode === dialCode);
};
